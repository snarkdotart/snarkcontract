...
contract SnarkLoan is Ownable, SnarkDefinitions {
    ...
    function createLoan(uint256[] tokensIds, uint256 startDate, uint256 duration) public {
        ...
        uint256 loanId = _storage.createLoan(tokensIds, startDate, duration, msg.sender);
